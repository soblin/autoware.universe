 ...
 * declaration part
 */
extern template Point2d to_bg2d(const geometry_msgs::msg::Point &);
extern template Point2d to_bg2d(const geometry_msgs::msg::Pose &);
extern template LineString2d to_bg2d(const std::vector<geometry_msgs::msg::Pose> &);
