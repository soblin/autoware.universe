 ...
 * definition part
 */
template Point2d to_bg2d(const geometry_msgs::msg::Point &);
template Point2d to_bg2d(const geometry_msgs::msg::Pose &);
template LineString2d to_bg2d(const std::vector<geometry_msgs::msg::Pose> &);
